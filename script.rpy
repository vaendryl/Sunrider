...
label battlefarportstart:
    ...
    kay "The enemy outnumbers, outguns, and outpowers us one to six."
    kay "But in the face of such odds, we will not scatter, but instead charge forward to meet the enemy head on!"
